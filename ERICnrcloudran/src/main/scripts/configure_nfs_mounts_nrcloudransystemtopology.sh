SEC_KEY='/opt/ericsson/nrcloudransystemtopology/lib/crypt.py'
NFS_NRCRAN=/ericsson/tor/no_rollback/nrcloudransystemtopology
NFS_CRONBACKUPS=$NFS_NRCRAN/cron_backups
NFS_SECUREDIR=$NFS_NRCRAN/secure
NFS_EXPORT=$NFS_NRCRAN/export

DIR_ARR=($NFS_NRCRAN $NFS_CRONBACKUPS $NFS_SECUREDIR $NFS_EXPORT)
SCRIPTING_GID=5003
LOG_TAG="PostInstall"
SCRIPT_NAME="${0}"
